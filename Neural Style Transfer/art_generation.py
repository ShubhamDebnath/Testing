...
def model_nn(model, sess, input_image, train_step, style_string, content_string, num_iterations = 200):
...
#     cap = cv2.VideoCapture("videos/{}.mp4".format(video_name))
#     print("video opened")
#     fourcc = cv2.VideoWriter_fourcc(*'XVID')
#     out_string = "output/{0}/{0}_{1}.avi".format(style_string, video_name)
...
#             generated_image = model_nn(model, sess, generated_image, train_step, style_string, content_string, num_iterations = 200)
